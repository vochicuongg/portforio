...
// ===================== 14. MOBILE BOTTOM NAV — ACTIVE STATE =====================
const bottomNavLinks = document.querySelectorAll('.bottom-nav-link');

// Map each nav link to the section it corresponds to
const bottomNavMap = {
    bnHome: 'hero',
    bnAbout: 'about',
    bnSkills: 'skills',
...
function updateBottomNav() {
    ...
    Object.entries(bottomNavMap).forEach(([linkId, sectionId]) => {
...
// Smooth scroll + haptic-feel tap on bottom nav
bottomNavLinks.forEach(link => {
    link.addEventListener('click', (e) => {
